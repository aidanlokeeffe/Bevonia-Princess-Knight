...
demo.art.prototype = {
    ...
    // ENVIRONMENT (TILEMAPS, TILESETS, BACKGROUNDS)
        ...
        game.load.image('bg0','assets/tilesets_backgrounds/tutorial background.png')
        // Level One
...
//        game.load.image("spikes", "assets/tilesets_backgrounds/deathSpikes.png");
    ...
    // AUDIO
        ...
        game.load.audio("glass", "assets/sounds/glassBreak.mp3");
        
        
        // Music
        game.load.audio('titleMusic', 'assets/sounds/menu.mp3');
        game.load.audio('cutsceneMusic', 'assets/sounds/cutsceneMusic.mp3');
